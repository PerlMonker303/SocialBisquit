<?php
  ...
  while($rowContact = mysqli_fetch_assoc($resultContact)){
    ...
    echo '
      <div class="container-friend" onclick="toggleOtherProfile('.$localFriendNumber++.')">
        <p><img src="Pictures/'.$contactImgPath.'"></img> <span>'.$contactFName.'</span> <span>'.$contactLName.'</span></p>
