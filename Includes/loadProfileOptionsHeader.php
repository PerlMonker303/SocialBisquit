<?php
  ...
  if(!mysqli_stmt_prepare($stmt, $sql)){
    ...
    if(($rowCheck['secretAnswer'] && $rowCheck['secretAnswer'] == 'empty') || !$rowCheck['secretAnswer']){
      ...
      //selecting shares
      $sql_shares = "SELECT * FROM tbl_shares WHERE idUser=?";
      $stmt_shares = mysqli_stmt_init($conn);
      mysqli_stmt_prepare($stmt_shares, $sql_shares);
      mysqli_stmt_bind_param($stmt_shares, 'i', $sessionUserId);
      mysqli_stmt_execute($stmt_shares);
      mysqli_stmt_store_result($stmt_shares);
      $sharesCount = mysqli_stmt_num_rows($stmt_shares);
